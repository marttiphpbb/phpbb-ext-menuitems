...
class links
{
	const OVERALL_HEADER_NAVIGATION_PREPEND = 1;
	const OVERALL_HEADER_NAVIGATION_APPEND 	= 2;
	const NAVBAR_HEADER_QUICK_LINKS_BEFORE 	= 4;
	const NAVBAR_HEADER_QUICK_LINKS_AFTER 	= 8;
	const OVERALL_HEADER_BREADCRUMBS_BEFORE = 16;
	const OVERALL_HEADER_BREADCRUMBS_AFTER	= 32;
	const OVERALL_FOOTER_TIMEZONE_BEFORE	= 64;
	const OVERALL_FOOTER_TIMEZONE_AFTER		= 128;
	const OVERALL_FOOTER_TEAMLINK_BEFORE	= 256;
	const OVERALL_FOOTER_TEAMLINK_AFTER		= 512;
